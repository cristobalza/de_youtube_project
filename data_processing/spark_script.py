...
datasource0 = glueContext.create_dynamic_frame.from_catalog(database = "db_youtubekaggle_raw", table_name = "raw_statistics", transformation_ctx = "datasource0", push_down_predicate = predicate_pushdown)
